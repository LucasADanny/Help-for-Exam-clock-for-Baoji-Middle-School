...
exams[281] = {
  type: "高一",
  author: "来源:高一28班 Lucas A Danny",
  origin: "2028届年级部",
  rollSlogan: ["高一第一学期期末考试：请以实际铃声为准。"],
  schedule() {
    $("语文", "2026-1-28", "08:00", "10:00");
    $("生物", "2026-1-28", "10:30", "12:00");
    $("数学", "2026-1-28", "14:10", "15:50");
    $("化学", "2026-1-28", "16:20", "17:50");
    $("政史", "2026-1-29", "08:00", "10:00");
    $("物理", "2026-1-29", "10:30", "12:00");
    $("英语", "2026-1-29", "14:10", "15:50");
    $("地理", "2026-1-29", "16:20", "17:20");
  }
};
